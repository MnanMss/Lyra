...
export interface LyraApi {
	...
	sessions: {
		...
		create(cwd: string, modelId: string, initial?: { content: UserContent[]; synthetic?: boolean; displayText?: string; skillRef?: { name: string; path?: string; pluginId?: string }; sessionRefs?: Array<{ id: string; title: string }>; fileRefs?: Array<{ name: string; path: string }>; attachments?: Array<{ name: string; kind?: string; mimeType?: string }> }): Promise<SessionSnapshot>;
	...
	agent: {
		 ...
		 */
		prompt(sessionId: string, content: UserContent[], options?: { synthetic?: boolean; deliver?: "steer" | "followUp"; resumePending?: boolean; displayText?: string; skillRef?: { name: string; path?: string; pluginId?: string }; sessionRefs?: Array<{ id: string; title: string }>; fileRefs?: Array<{ name: string; path: string }>; attachments?: Array<{ name: string; kind?: string; mimeType?: string }> }): Promise<SessionMeta>;
		/**
		 ...
		 */
		editMessage(sessionId: string, messageIndex: number, content: UserContent[], options?: { displayText?: string; fileRefs?: Array<{ name: string; path: string }>; attachments?: Array<{ name: string; kind?: string; mimeType?: string }> }): Promise<void>;
