...
export async function runSubAgent(
	...
	const delivered = (yielded && renderYield(yielded) ? renderYield(yielded) : "") || prose;
	...
	return { text: answer, output: (yielded && renderYield(yielded) ? yielded.value : undefined), warnings: yielded?.warnings };
}
